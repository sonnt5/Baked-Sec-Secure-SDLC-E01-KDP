...
export default function Toast({ id, type, message, duration = 5000, onClose }: ToastProps) {
  ...
  return (
    <div
      className={`flex items-center p-4 ${styles.bg} border ${styles.border} rounded-md shadow-lg mb-4 animate-slide-in`}
      role="alert"
    >
      ...
      <button
        onClick={() => onClose(id)}
        className={`ml-4 flex-shrink-0 ${styles.text} hover:opacity-75 focus:outline-none`}
        aria-label="Close"
      >
